 ...
 */
function classifyEthTagPayMode(tx) {
    try {
...
/**
 * Ethereum: verify ZelfEthPay tx receipt + Paid event vs JWT smartContractETH slice.
 */
async function verifyEthZelfTagPayTx({
    normalizedHash,
    expectedContract,
    chainId,
    rpcUrl,
    ...
    const payMode = classifyEthTagPayMode(tx);
