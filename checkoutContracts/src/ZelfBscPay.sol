...
/**
 * @title ZelfBscPay
 * @notice Accepts native BNB or USDC / USDT (ERC-20), forwards to a fixed treasury. Emits Paid for off-chain verification.
...
contract ZelfBscPay {
    ...
    /**
     * @param paymentId Server-issued binding (keccak256 over session data), must match JWT smartContractBSC.paymentId
